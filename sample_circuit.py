...
ckpt_path = os.path.join(cp_dir, 'ckpt_circuit.pt')
...
for i in range(3):
    ...
    print('Resulting states, computed by simulating the circuits generated by the output code')
    for N in [1,2,3,4]:
        ...
        print(f'state generated for N = {N}')
        print(kets)
    print('\n')
